...
const AXES = [
  {
    axis: 'LF',
    title: '第1軸：主導か服従か',
    subtitle: '恋愛における主導権の在り方',
    leftLabel: 'L｜主導（Leader）',
    rightLabel: 'F｜服従（Follower）',
  ...
  },
  {
    ...
    title: '第3軸：日常か非日常か',
    subtitle: '関係性の時間軸',
    leftLabel: 'D｜日常（Daily）',
    rightLabel: 'N｜非日常（Non-daily）',
  ...
  },
  {
    ...
    title: '第4軸：純粋か倒錯か',
    subtitle: '快楽の形',
    leftLabel: 'S｜純粋（Simple）',
    rightLabel: 'P｜倒錯（Perverse）',
